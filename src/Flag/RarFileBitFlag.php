...
final class RarFileBitFlag
{
     ...
     */
    public const FILE_CONTIUNED_FROM_PREV_VOLUME = 0x01;

    /**
     * File continued in next volume.
     */
    public const FILE_CONTIUNED_IN_NEXT_VOLUME = 0x02;

    /**
     * File encrypted with password.
     */
    public const FILE_ENCRYPED_WITH_PASSWORD = 0x04;

    /**
     * Comment block.
     */
    public const COMMENT_BLOCK = 0x08;
     ...
     */
    public const HIGH_PACK_AND_UNP_SIZE = 0x100;
     ...
     */
    public const UNICODE_FILE_NAME = 0x200;
